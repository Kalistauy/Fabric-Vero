...
$sourceStageName = "Test"                    # The name of the source stage
$targetStageName = "Production"                    # The name of the target stage
$deploymentNote = "Despliegue automático desde Test a Prod"                       # The deployment note (Optional)
...
/deploymentPipelines/{1}/stages" -f $baseUrl, $deploymentPipelineId
...
try {
    ...
    $deploymentPipelineId = "github-integration-pipelines" 
    $sourceStageId = "e4fdc84a-b2c0-446a-943a-bc4ce7d9d8c7"
    $targetStageId = "ade9cb08-1910-416c-bbd3-81b5abf2e61f"
    ...
    $deployUrl = "{0}/deploymentPipelines/{1}/deploy" -f $baseUrl, $deploymentPipelineId
